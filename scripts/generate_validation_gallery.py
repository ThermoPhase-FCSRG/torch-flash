...
FIGURES = (
    ...
    FigureSpec(
        "09_gerg2008_h2_ch4_density.png",
        "09_gerg2008_hydrogen_native",
        "notebooks/verification/09_gerg2008_hydrogen_native.ipynb",
        7,
        0,
        "verification",
        True,
        ("gerg2008_h2_ch4_reference.csv",),
        (
            "https://doi.org/10.1021/je300655b",
            "https://doi.org/10.6084/m9.figshare.12063297",
        ),
        "Native GERG-2008 density reproduction over all 1,010 H2-CH4 reference states.",
    ),
    FigureSpec(
        "09_gerg2008_h2_ch4_caloric.png",
        "09_gerg2008_hydrogen_native",
        "notebooks/verification/09_gerg2008_hydrogen_native.ipynb",
        9,
        0,
        ...
        "Native GERG-2008 isobaric-heat-capacity reproduction over all 1,010 "
        "H2-CH4 reference states.",
    ),
    FigureSpec(
    ...
    FigureSpec(
        "29_h2_gerg_table12_parity.png",
        "29_hydrogen_tailored_gerg_2021",
        "notebooks/local-only/validation/29_hydrogen_tailored_gerg_2021.ipynb",
        11,
        0,
        "verification",
        True,
        ("beckmuller_2021_h2_gerg_table12.csv",),
        ("https://doi.org/10.1063/5.0040533",),
        "Parity for all six properties and all 16 states in Beckmuller et al. Table 12.",
    ),
    FigureSpec(
        "29_h2_gerg_figure4_density_difference.png",
        "29_hydrogen_tailored_gerg_2021",
        "notebooks/local-only/validation/29_hydrogen_tailored_gerg_2021.ipynb",
        16,
        0,
        ...
        (),
        ("https://doi.org/10.1063/5.0040533",),
        "CH4-H2 density difference between GERG-2008 and the H2-tailored "
        "parameterization with calculated phase boundaries.",
    ),
    FigureSpec(
        "29_h2_gerg_figure7_n2_h2_vle.png",
        "29_hydrogen_tailored_gerg_2021",
        "notebooks/local-only/validation/29_hydrogen_tailored_gerg_2021.ipynb",
        19,
        0,
        "validation",
        True,
        ("beckmuller_2021_h2_vle_digitized.csv",),
        ("https://doi.org/10.1063/5.0040533",),
        "Native N2-H2 phase-equilibrium traces for the three Figure 7 "
        "isotherms with digitized experimental markers.",
    ),
    FigureSpec(
        "29_h2_gerg_figure16_co2_h2_vle.png",
        "29_hydrogen_tailored_gerg_2021",
        "notebooks/local-only/validation/29_hydrogen_tailored_gerg_2021.ipynb",
        19,
        1,
