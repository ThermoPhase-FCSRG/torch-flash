...
| Physical phase identification | K. S. Pedersen, P. L. Christensen, and J. A. Shaikh, *Phase Behavior of Petroleum Reservoir Fluids*, 3rd ed., CRC Press (2024), section 6.6. The implemented SRK/PR rule uses \(V/b=1.75\); density ordering is retained only as a likely multiphase fallback. [doi:10.1201/9780429457418](https://doi.org/10.1201/9780429457418) |
