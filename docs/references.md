...
| Physical phase identification | J. Bennett and Z. Schmidt, "Comparison of Phase Identification Methods Used in Petroleum Reservoir Simulation," *Energy & Fuels* 31 (2017) 3370-3379. The implementation exposes all five compared homogeneous-state criteria; the two derivative criteria use PyTorch autodiff. [doi:10.1021/acs.energyfuels.6b02316](https://doi.org/10.1021/acs.energyfuels.6b02316). K. S. Pedersen, P. L. Christensen, and J. A. Shaikh, *Phase Behavior of Petroleum Reservoir Fluids*, 3rd ed., CRC Press (2024), section 6.6, supplies the default SRK/PR \(V/b=1.75\) rule. [doi:10.1201/9780429457418](https://doi.org/10.1201/9780429457418) |
